...
define dso_local i32 @main() #0 {
  ...
  %21 = call double @check_add(double %19, double %20)
...
define double @check_add(double %0, double %1) {
entry:
  %fadd_res = fadd double %0, %1
  %cmp_ins = fcmp ogt double %fadd_res, 1.000000e+02
  br i1 %cmp_ins, label %bigger, label %smaller

bigger:                                           ; preds = %entry
  %frem_res = frem double %fadd_res, 1.000000e+02
  ret double %frem_res
