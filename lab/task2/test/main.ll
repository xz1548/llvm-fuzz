...
@.str.1 = private unnamed_addr constant [7 x i8] c"100.00\00", align 1
@.str.2 = private unnamed_addr constant [21 x i8] c"%.2f + %.2f = %.2f \0A\00", align 1
...
23:                                               ; preds = %0
  ...
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0), double %24, double %25, double %28)
  br label %30
