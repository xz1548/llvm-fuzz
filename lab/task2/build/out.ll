...
define dso_local i32 @main() #0 {
  ...
  %cmp_ins = fcmp ogt double %21, 1.000000e+02
  br i1 %cmp_ins, label %trueBB, label %falseBB

falseBB:                                          ; preds = %trueBB, %0
  %phi = phi double [ %21, %0 ], [ 1.000000e+02, %trueBB ]
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), double %17, double %18, double %phi)
